...
int main() {
  ...
  double sumasp1 = sp1.SumarCoeficientes();
  double sumasp2 = sp2.SumarCoeficientes();
  double sumasp3 = sp3.SumarCoeficientes();

  std::cout << "Suma sp1: " << sumasp1 << std::endl;
  std::cout << "Suma sp2: " << sumasp2 << std::endl;
  std::cout << "Suma sp3: " << sumasp3 << std::endl;

  std::cout << "sp1= " << sp1 << std::endl << "sp3= " << sp3 << std::endl;
  std::cout << "Sp1 * Sp3 = ";
  double x = sp1.ProductoEscalar(sp3);
  std::cout << x << std::endl;

  std::cout << "Producto por vector disperso sp1= " << sp1 << std::endl
            << "p3= " << p3 << std::endl;
  std::cout << "Sp1 * p3 = ";
  double y = sp1.ProductoConVectorDenso(p3);
  std::cout << y << std::endl;
